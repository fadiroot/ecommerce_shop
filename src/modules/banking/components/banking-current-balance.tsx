...
// utils
import { fCurrency } from 'src/modules/shared/utils/format-number';
// hooks
...
import Carousel, { CarouselDots, useCarousel } from 'src/modules/shared/components/carousel';
        ...
        <div>
          ...
          <Stack direction="row" alignItems="center" spacing={1}>
            ...
            <IconButton
              ...
              sx={{ marginBottom: currency.value ? '10px' : '0px' }}
            >
